...
from models.Models.replkdext import RepLKDeXt
...
# class Conv(nn.Module):     用slimneck的时候要用这个卷积 把上面那个替换了  但是这个模块并不轻 辣鸡 别用了
#     default_act = nn.SiLU()  # default activation
...
class PatchEmbed_FasterNet(nn.Module):
    #  embed_dim相当于out_chans,   patch_size相当于kernel_size
