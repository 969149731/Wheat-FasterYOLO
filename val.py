...
from yolo.utils.general import LOGGER, check_requirements, print_args, increment_path
...
def parse_opt():
    ...
    parser.add_argument('--yolo-weights', type=str, default=WEIGHTS / 'Wheat-FasterYolo.pt', help='model.pt path(s)')
    ...
    parser.add_argument('--benchmark', type=str,  default='MOTCUSTOM', help='MOT16, MOT17, MOT20')
    parser.add_argument('--split', type=str,  default='test', help='existing project/name ok, do not increment')
